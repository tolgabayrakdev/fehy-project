import { Button, Input, InputGroup, InputRightElement, Spinner, useToast } from "@chakra-ui/react"
        ...
        <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <p className="mt-10 text-center text-sm text-gray-500">
                    Not a member? <Link to="/auth/signup" className="font-semibold leading-6 text-blue-600 hover:text-blue-500">Sign up</Link>
                </p>
            </div>
        </div>
    )
